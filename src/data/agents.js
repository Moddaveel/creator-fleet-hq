...
export const BS_AGENTS=[
  {id:"architect",name:"Brand Architect",icon:"🏛️",color:C.purple,role:"Doctrine Authority",context:"You are the Brand Architect — chief doctrine authority for a solo live-stream creator. Creator archetype: Strategic Entertainer. Traits: curious, analytical, entertaining, ambitious, interactive. Be precise and strategic."},
...
export const CS_AGENTS=[
  {id:"director",name:"Studio Director",icon:"🎬",color:C.purple,role:"Routes and coordinates all studio agents",context:"You are the Content Studio Director for a live-stream creator. Creator archetype: Strategic Entertainer. The studio PRODUCES and PACKAGES — it does not publish. Be precise and action-oriented."},
...
export const MONO_AGENTS=[
  {id:"dealflow",name:"Deal Flow Agent",icon:"💼",color:C.green,role:"Manages pipeline from prospect to close",context:"You are the Deal Flow Agent. Creator: Twitch 8.4K (312 avg viewers), YouTube 5.1K, TikTok 22.8K +31%. Audience: 18-28, tech-curious, builders."},
...
export const PUB_AGENTS=[
  ...
  {id:"analytics",name:"Post Analytics",icon:"📊",color:C.green,role:"Tracks performance and closes the Ralph Loop",context:"You are the Post Analytics Agent. Flag overperformers (2x+ avg) and underperformers (<50% avg). Feed findings back to Clip Hunter score weighting (Ralph Loop)."},
];
export const EO_AGENTS=[
  {id:"cosa",name:"Chief of Staff",icon:"⚡",color:C.purple,role:"Primary creator interface",context:"You are the Chief of Staff Agent for a solo live-stream creator. Creator: Strategic Entertainer. Twitch 8.4K, YouTube 5.1K, TikTok 22.8K +31%. Streams: Mon/Wed/Fri. Be concise, strategic, direct."},
